...
export default function Footer() {
          ...
          <div className="col-start-1 flex items-center justify-start mr-5 mb-10">
            <Link href="/">
              <a className="flex">
                ...
                <h1 className="font-bold text-xl ml-2 leading-3">
                  DailyThought <br />
                  <span className="text-sm font-normal text-pink-800 max-w-xs">
                    A place for you daily thoughts, funny texts, and images
                  </span>
                </h1>
              </a>
            </Link>
  ...
  return (
    <footer className="w-full bg-pink-200 text-pink-900 p-10 border-t border-pink-300">
      <div className="max-w-3xl mr-auto ml-auto">
        <div className="col-start-1 flex items-center justify-start mb-5">
          <Link href="/">
            <a>
              <div className="flex flex-wrap">
                ...
                <h1 className="font-bold text-xl ml-2 leading-5">
                  DailyThought <br />
                  <span className="text-sm font-normal text-pink-800">
                    A place for you daily thoughts, funny texts, and images
                  </span>
                </h1>
              </div>
